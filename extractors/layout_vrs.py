...
Phase-F-Fix (F7): Selma-Steueraufstellungen weisen VRS nicht als
...
def extract_vrs_total_selma(
    ...
    """VRS-Extraktion für Selma-Layout: Subtotal-Ertrag-Spalte-A × 35%.
...
def extract_vrs_total(words: list[dict]) -> tuple[str, dict] | None:
    """Wrapper für VRS-Layout-Extraktion. Aktuell nur Selma-Variante."""
