...
FIELD_LABEL_PRIORS: dict[tuple[str, str], list[str]] = {
    ...
    ("bank_zinsausweis", "vermoegensstand_3112"): [
        "Saldo zu Ihren Gunsten",        # BANK-R
        "Kontostand nach Zinsabschluss", # BANK-P TAX_P
        "Endsaldo",
        "Guthabensaldo",                  # BANK-H
        "Kontostand",                     # BANK-P Zinsabrechnung (generisch, last resort)
    ...
    ("bank_zinsausweis", "bruttoertrag"): [
        "Bruttozins",   # BANK-P TAX_P
        "Zinszahlung",  # BANK-R
        "Habenzins",    # BANK-P Zinsabrechnung
    ],
}
