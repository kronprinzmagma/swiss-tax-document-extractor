...
Beispiel: PostFinance-Jahresgebühren (Vermögensverwaltungskosten) sind für
...
OUT_OF_SCOPE_PATTERNS: list[tuple[re.Pattern[str], str, str]] = [
    # PostFinance Jahresgebühr: Dateiname enthält "Jahresgebühr" direkt.
...
def classify_out_of_scope(text: str, pdf_name: str = "") -> tuple[str, str] | None:
    ...
    Manche Out-of-Scope-Marker stehen nur im Dateinamen (z.B. PostFinance-
