...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([_w("Bank-Zinsausweis"), _w("UBS")], ("bank_zinsausweis", None)),
        ...
        ([_w("Wertschriftenverzeichnis"), _w("UBS")], ("wertschriftenverzeichnis", None)),
        ([_w("Depot-Auszug"), _w("ZKB")], ("wertschriftenverzeichnis", None)),
