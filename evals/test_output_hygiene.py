...
def zeile(pdf: str, besch: str, betrag: str | None, aussteller: str = "PostFinance") -> dict:
...
def test_aussteller_varianten_werden_zusammengefuehrt():
    for variante in ("PostFinance", "PostFinance AG", "Post CH AG", "postfinance ag"):
        assert normalize_aussteller(variante) == "PostFinance"
