...
def process_json_sample(json_path: Path, model: str | None = None,
    ...
    # F7-Layout-Extraktion (BROKER-S-WSV): VRS nicht als Label, sondern als
    ...
    # LLM erfindet manchmal echte Firmennamen ("KK-W", "KK-C", "Muster-Universität"),
    ...
    for fname in schema_class.model_fields:
        ...
        # für verrechnungssteuer_total mit Layout-Rule (BROKER-S) markieren;
    ...
    def _label_snippet(label: str, occurrence: int = 0, following: int = 5):
        ...
        Ziffern im OCR-Text getrennt/umgestellt stehen (BANK-H: '.56 1'234')."""
    ...
    def _make_extra_field(feld: str, value: str, source: str,
        ...
        # Fallback 2: Label-gebundener Nachweis (OCR-getrennte Ziffern, z.B. BANK-H)
        if label:
